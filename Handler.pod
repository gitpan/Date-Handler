...
Date::Handler - Easy but complete date object (0.10)
...
=item * Changing the object's locale on the fly using Locale()
...
Examples:
	...
	$date->Locale('french');
	print "Time in french: ".$date."\n";
	$date->Locale('deutsch');
	print "Time in german: ".$date."\n";
	$date->Locale('spanish');
	print "Time in spanish: ".$date."\n";
...
cvs -d:pserver:anoncvs@cvs.flatlineconstruct.com:/home/cvs/anon checkout Date-Handler
...
Patrick Bradley <peanut@burstofindifference.com>
